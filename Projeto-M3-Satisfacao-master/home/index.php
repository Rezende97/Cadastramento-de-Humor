...
if (isset($_GET['finish_tutorial']) && $_GET['finish_tutorial'] == true) {
	...
	# atualiza registro
	$stmt = $db->getConnection()->prepare('UPDATE users SET tutorial = 1 WHERE id = :user_id');
		...
		<div class="container">
			<div class="row" id="center">
				<div class="col-sm-10 pt">
					...
					<form class="form-check" action="finaliza.php" method="post">
						...
						<div>
							<label id="enable-comment">
								<input type="checkbox" name="checkbox_comment" onclick="enableComment()">
								&nbsp;Incluir comentário
							</label>
						</div>
