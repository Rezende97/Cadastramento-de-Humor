...
<form action="consulta_admin.php?order=date" method="post">
    <div class="container-data">
        <label>Data inicial:
            <input type="date" class="verificaData" id="d_Inicio" name="d_Inicio" min="<?php echo $dInicio ?>" max=" <?php echo $dFim ?>">
        </label>
        <p>
        <label>Data final:
            <input type="date"  class="verificaData" id="d_Fim" name="d_Fim" min="<?php echo $dInicio ?>" max=" <?php echo $dFim ?>">
        </label>
    </div>
    <div id="mensagem"></div>
